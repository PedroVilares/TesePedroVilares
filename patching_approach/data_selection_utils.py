...
def image_mover(df,p_dict):
    ...
    for patient in p_dict.keys():
        ...
        for n in patient_lines.index:
            ...
            ages.append(patient_lines['age'][n])
            lesions.append(patient_lines['lesion_type'][n])
            image_paths.append(image_path)
        print('Patient',patient,'saved!')
        num+=1
    return patients,image_views,labels,x_centers,y_centers,densities,image_paths,ages,lesions
